...
I build tools, automations, and experiments around DevOps, infrastructure, and data.  
Most of my work focuses on simplifying operational complexity and enabling reproducibility.

I like:
- bleeding-edge environments  
- eliminating manual work  
- automating the boring (and sometimes the impossible)
